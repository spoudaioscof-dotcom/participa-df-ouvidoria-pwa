...
* Inclusão digital por meio da voz
* Multimodalidade real
* Funcionamento em baixa conectividade
* Uso de dados reais anonimizados
* Aderência às normas públicas (LGPD e WCAG)
* Solução factível e escalável

---

## Entregáveis do Hackathon

* PWA funcional (demo navegável)
* Arquitetura técnica documentada
* Diagrama visual da solução
* README técnico
* Demonstração com dados reais anonimizados
